  ...
  `;
  export const ADMIN_GET_ALL_SIZES_QUERY = gql`
  query AdminGetAllSizes { # Tên query này phải khớp với định nghĩa ở backend
    adminGetAllSizes { # Tên trường trả về từ backend
      size_id
      size_name
    }
  }
